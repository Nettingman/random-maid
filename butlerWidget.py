...
import data.colors as maidColors, data.butlerTypes as butlerTypes, data.butlerPowers as butlerPowers, data.butlerRoots as butlerRoots, data.butlerSpecialQualities as butlerQualities, data.butlerWeapons as butlerWeapons
